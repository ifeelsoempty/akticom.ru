<template>
  <header class="header">
    <div class="header__wrapper container">
      <div class="header__logo cursor-magnet">
        <svg data-cursor-type="large" width="50" height="67" viewBox="0 0 50 67" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav class="header-nav">
        <ul class="header-nav__links">
          <li class="header-nav__link">
            <a data-cursor-type="medium" href="#">Проекты</a>
          </li>
          <li class="header-nav__link">
            <a data-cursor-type="medium" href="#">Услуги</a>
          </li>
          <li class="header-nav__link">
            <a data-cursor-type="medium" href="#">Команда</a>
          </li>
        </ul>
      </nav>
