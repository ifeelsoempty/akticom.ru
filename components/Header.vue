<template>
  <header class="header">
    <div class="header__wrapper container">
      <svg class="header__logo t-stairs t-stairs__leave-to" data-t-delay="1000" width="50" height="67" viewBox="0 0 50 67" xmlns="http://www.w3.org/2000/svg">
...
<style lang="scss">
  ...
  .t-stairs {
    transition: transform 1s ease-in-out, opacity 1s ease-in-out, color $t-link-duration ease-in-out;
  }
  .t-stairs__leave-to {
