      ...
      <div :class="{ active: activeSlide === 1 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-1.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 2 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-2.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 3 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-3.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 4 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-4.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 5 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-5.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 6 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-6.png" alt="">
          </div>
        </div>
      </div>
      <div :class="{ active: activeSlide === 7 }" class="w-slide">
        <div class="container">
          <div class="w-slider__background">
            ...
            <img class="w-slider__rain" src="@/assets/images/rains/slide-7.png" alt="">
          </div>
        </div>
      </div>
    </div>
